...
def main():
    ...
    # abs path: os.path.join(os.path.dirname(__file__), 'train_list.txt')
    ...
    ### model = torch.load('/path/to/checkpoint.pt')
    criterion = nn.L1Loss()
    ...
    for filename in os.listdir(checkpoint_dir):
        if filename.startswith('pix2pix_model_epoch_') and filename.endswith('.pth'):
